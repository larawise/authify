...
class ResetLimiter
{
    ...
    {
        return Str::transliterate('authify_reset|'.$request->ip());
    }
    ...
    {
        return config('authify.limiters.reset.decay_seconds', 900);
    }
    ...
    {
        return config('authify.limiters.reset.max_attempts', 5);
    }
}
