...
class LoginLimiter
{
    ...
    {
        return Str::transliterate('authify_login|'.$request->ip());
    }
    ...
    {
        return config('authify.limiters.login.decay_seconds', 900);
    }
    ...
    {
        return config('authify.limiters.login.max_attempts', 5);
    }
}
