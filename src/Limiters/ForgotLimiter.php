...
class ForgotLimiter
{
    ...
    {
        return Str::transliterate('authify_forgot|'.$request->ip());
    }
    ...
    {
        return config('authify.limiters.forgot.decay_seconds', 900);
    }
    ...
    {
        return config('authify.limiters.forgot.max_attempts', 5);
    }
}
